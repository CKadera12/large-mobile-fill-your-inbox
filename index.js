...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[322,0,114,60],[438,31,30,29],[438,0,30,29],[115,162,113,58],[345,242,113,58],[0,282,113,58],[115,222,113,58],[230,242,113,58],[115,102,113,58],[0,162,113,58],[345,122,113,58],[322,62,113,58],[115,282,113,58],[230,182,113,58],[345,182,113,58],[0,102,113,58],[230,122,113,58],[0,222,113,58],[0,0,320,100],[437,62,43,47]]}
];
...
(lib.largemobileslidetransitionfillinboxsomethingdelicious = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(149).to({x:-30.5},0).to({x:57.5,alpha:1},11,cjs.Ease.get(1)).to({x:52.5},6,cjs.Ease.get(1)).wait(30).to({alpha:0},5).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(46).to({x:-88.7},0).to({x:115.7,alpha:1},11).to({x:110.7},6,cjs.Ease.get(1)).wait(86).to({alpha:0},5).wait(113));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(196).to({x:-84.8},0).to({x:108.1,alpha:1},11).to({x:103.1},6).wait(30).to({alpha:0},5).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(243).to({x:-92.5},0).to({x:115.8,alpha:1},11).to({x:110.8},6).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(140).to({x:251.5,alpha:1},0).wait(127));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(137).to({x:251.5,alpha:1},0).wait(130));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(130).to({alpha:1},0).wait(137));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(123).to({alpha:1},0).wait(144));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(119).to({alpha:1},0).wait(148));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(115).to({alpha:1},0).wait(152));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(111).to({alpha:1},0).wait(156));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(107).to({alpha:1},0).wait(160));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(103).to({alpha:1},0).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(99).to({alpha:1},0).wait(168));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(95).to({alpha:1},0).wait(172));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(91).to({alpha:1},0).wait(176));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(87).to({alpha:1},0).wait(180));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(83).to({alpha:1},0).wait(184));
