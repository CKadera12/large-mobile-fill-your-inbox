...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[322,0,114,60],[438,0,30,29],[438,31,30,29],[230,122,113,58],[345,122,113,58],[0,162,113,58],[115,162,113,58],[230,182,113,58],[345,182,113,58],[0,222,113,58],[115,222,113,58],[230,242,113,58],[345,242,113,58],[0,282,113,58],[115,282,113,58],[322,62,113,58],[0,102,113,58],[115,102,113,58],[0,0,320,100],[437,62,43,47]]}
];
...
(lib.signuplargemobile = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(72.2,0.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgZAqIAAhTIAQAAIAABGIAjAAIAAANg");
	this.shape_1.setTransform(66.1,0.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgGAqIAAhTIANAAIAABTg");
	this.shape_2.setTransform(60.8,0.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAaAqIgIgTIgkAAIgHATIgRAAIAlhTIAMAAIAkBTgAANAKIgNghIgMAhIAZAAg");
	this.shape_3.setTransform(54.6,0.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAfAqIAAhDIgaBDIgKAAIgZhDIAABDIgPAAIAAhTIAYAAIAVA7IAAAAIAWg7IAYAAIAABTg");
	this.shape_4.setTransform(44.7,0.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgcAqIAAhTIA3AAIAAAMIgoAAIAAAXIAmAAIAAALIgmAAIAAAYIAqAAIAAANg");
	this.shape_5.setTransform(35.6,0.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AANAqIgSgkIgLAAIAAAkIgPAAIAAhTIAdAAQAGgBAFACQAGABAEADQAFADACAEIACAGIABAGQAAAJgGAGQgEAFgKACIAXAlgAgQgFIAMAAIAGAAIAGgCIAEgEQACgDgBgDQABgDgCgDIgEgEIgGgCIgFAAIgNAAg");
	this.shape_6.setTransform(25,0.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(15.6,0.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgaAqIAAhTIA1AAIAAAMIgmAAIAAAYIAkAAIAAAMIgkAAIAAAjg");
	this.shape_8.setTransform(7.1,0.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgdAqIAAhTIAcAAQAGgBAGACQAGABAEADQAEADADAFQACAFAAAGIgBAGIgCAGQgCAFgFACIgKAEQgGABgGAAIgMAAIAAAjgAgOgEIALAAIAGgBIAGgCIAEgEQACgCAAgEQAAgDgCgDIgEgEIgGgCIgGAAIgLAAg");
	this.shape_9.setTransform(-3.4,0.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgMApQgHgCgEgFIgEgEIgEgGIgBgGIgBgHIAAg1IAPAAIAAA0IABAHQABAEACACQACADAEADQAEABAEAAQAFAAAEgBIAGgGQACgCABgEIABgHIAAg0IAPAAIAAA1IAAAHIgCAGQgDAGgFAEQgEAFgGACQgHACgHAAQgGAAgGgCg");
	this.shape_10.setTransform(-11.8,1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AASAqIgohAIAABAIgOAAIAAhTIAUAAIAmA+IAAg+IAQAAIAABTg");
	this.shape_11.setTransform(-24.1,0.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgLApIgIgDIgHgGQgGgGgDgIQgDgJAAgJQAAgKADgIQACgEACgDIAGgGIAHgGIAHgDQAJgDAJAAIAJAAIAJADQAJADAFAEIgLALQgDgDgGgDIgGgCIgGgBQgHABgEACQgGADgEADQgEAFgCAFQgCAGAAAGQAAAGACAHQACAFAEAEQAEAFAGACQAEACAHAAQAKAAAHgDIAAgWIgSAAIAAgLIAhAAIAAArIgOAFIgSABQgJAAgJgDg");
	this.shape_12.setTransform(-33.8,0.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgHAqIAAhTIAPAAIAABTg");
	this.shape_13.setTransform(-40.1,0.9);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("");
	this.shape_14.setTransform(-45.5,0.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.signuplargemobile, new cjs.Rectangle(-51,-8.6,129.1,18.8), null);
...
(lib.largemobileslidetransitionfillinboxsomethingdelicious = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(16).to({regX:0,regY:0,scaleX:0.01,scaleY:0.01,x:269,y:29.6},0).to({regX:2.5,regY:1.1,scaleX:0.22,scaleY:0.22,x:269.4,y:29.8,alpha:1},6).to({regX:1.2,regY:1,scaleX:0.21,scaleY:0.21,x:269.2},7,cjs.Ease.get(1)).wait(238));
	...
	this.timeline.addTween(cjs.Tween.get(this.cta_rollover).wait(61).to({x:-31.9,alpha:0},0).to({x:85.8,alpha:1},10).to({x:81.7},8).wait(188));
